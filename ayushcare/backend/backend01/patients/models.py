...
class PatientProfile(models.Model):
    ...
    past_medical_history = models.JSONField(default=list, blank=True, null=True)
    current_symptoms = models.JSONField(default=dict, blank=True, null=True)
    addictions = models.JSONField(default=list, blank=True, null=True)
    ...
    contraindications = models.JSONField(default=list, blank=True, null=True)
    treatment_goals = models.JSONField(default=list, blank=True, null=True)
